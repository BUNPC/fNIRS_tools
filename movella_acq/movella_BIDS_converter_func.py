...
def movella_BIDS_converter(subjID, tasks, tracked_point_mapping):
    ...
    try:
        listAll = os.listdir('MOVELLA')
    except:
        print('WARNING: MOVELLA folder not found in this directory. No files converted to BIDS.')
        return
    ...
    for dd, DIR in enumerate(listAll):
    
        dir_path = os.path.join('MOVELLA', DIR)
